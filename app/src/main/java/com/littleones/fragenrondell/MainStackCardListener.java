...
public class MainStackCardListener implements View.OnTouchListener {

    private static final String TAG = MainStackCardListener.class.getSimpleName();
    ...
    public MainStackCardListener(View frame, Object itemAtPosition, MoveListener moveListener) {
        this(frame, itemAtPosition, 0, 15f, moveListener);
    }

    public MainStackCardListener(View frame, Object itemAtPosition, float deltaElevation, float rotation_degrees, MoveListener moveListener) {
        super();
        this.frame = frame;
    ...
    public void onSelected(final boolean isDismiss, long duration) {
        ...
        if (isDismiss) {
            exitX = -objectW*4.f/5.f;
            exitY = (parentHeight-objectH)/2.f;
        ...
        this.frame.animate()
                ...
                .setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        if (isDismiss) {
                            mMoveListener.toDismissStack(dataObject);
                        }
